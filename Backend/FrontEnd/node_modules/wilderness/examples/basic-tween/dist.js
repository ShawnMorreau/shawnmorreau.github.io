...
var keyframe1 = { type: 'rect', width: 10, height: 10, x: 0, y: 0 };
var keyframe2 = { type: 'rect', width: 10, height: 10, x: 90, y: 90 };

var square = shape$1(keyframe1, keyframe2);
...
var animation = timeline$1(square, playbackOptions);
