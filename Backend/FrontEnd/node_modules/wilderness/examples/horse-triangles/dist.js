...
var keyframe1 = { el: horse, style: '', transforms: [['reverse']] };
var keyframe2 = { el: triangles, style: '', transforms: [['moveIndex', 6]] };
var playbackOptions = { alternate: true, iterations: Infinity, duration: 3000 };
var animation = timeline$1(shape$1(keyframe1, keyframe2), playbackOptions);
