...
var shape$1 = function shape$$1() {
  ...
  for (var i = 0, l = props.length; i < l; i++) {
    ...
    if (prop.el) {
      var p = _extends$11({}, plainShapeObject$2(prop.el), prop);
...
var shape1Keyframe1 = { type: 'rect', width: 10, height: 10, x: 10, y: 45, name: 'KEYFRAME_1' };
var shape1Keyframe2 = { type: 'rect', width: 10, height: 10, x: 40, y: 45, name: 'KEYFRAME_2' };

var shape1 = shape$1(shape1Keyframe1, shape1Keyframe2);

var shape2Keyframe1 = { type: 'rect', width: 10, height: 10, x: 50, y: 45, name: 'KEYFRAME_1' };
var shape2Keyframe2 = { type: 'rect', width: 10, height: 10, x: 70, y: 45, name: 'KEYFRAME_2' };

var shape2 = shape$1(shape2Keyframe1, shape2Keyframe2);

var playbackOptions = { alternate: true, duration: 10000, iterations: Infinity };

var animation = timeline$1([shape1, { name: 'SHAPE_1' }], [shape2, { name: 'SHAPE_2' }], playbackOptions);

animation.event.subscribe('timeline.start', function () {
  return console.log('timeline.start');
});
animation.event.subscribe('timeline.finish', function () {
  return console.log('timeline.finish');
});
animation.event.subscribe('shape.start', function (_ref) {
  var shapeName = _ref.shapeName;
  return console.log('shape.start ' + shapeName);
});
animation.event.subscribe('shape.finish', function (_ref2) {
  var shapeName = _ref2.shapeName;
  return console.log('shape.finish ' + shapeName);
});
animation.event.subscribe('keyframe', function (_ref3) {
  var keyframeName = _ref3.keyframeName,
      shapeName = _ref3.shapeName;
  return console.log('keyframe ' + shapeName + ' ' + keyframeName);
});
animation.event.subscribe('frame', function () {
