...
var output$1 = function output(x) {
  if ((typeof x === 'undefined' ? 'undefined' : _typeof$4(x)) === 'object' && x.middleware === name$1) {
    var values = x.values;
    var result = [];
...
var apply$1 = function apply(value, func) {
  ...
  if ((typeof v === 'undefined' ? 'undefined' : _typeof$5(v)) !== 'object') {
    return v;
...
var shapeWithOptionsFromArray = function shapeWithOptionsFromArray(_ref3, i) {
  ...
  if (true && ((typeof shape === 'undefined' ? 'undefined' : _typeof$2(shape)) !== 'object' || !shape.keyframes)) {
    throw new TypeError('When an array is passed to the timeline function the first item must be a Shape');
  }

  if (true && (typeof options === 'undefined' ? 'undefined' : _typeof$2(options)) !== 'object') {
  ...
  if ((typeof queue === 'undefined' ? 'undefined' : _typeof$2(queue)) === 'object' && !Array.isArray(queue) && queue !== null) {
...
var sort = function sort(props) {
  ...
  for (var i = 0, l = props.length; i < l; i++) {
    ...
    if (Array.isArray(prop)) {
      ...
      if (true && (typeof prop === 'undefined' ? 'undefined' : _typeof$2(prop)) !== 'object') {
...
var updatePlaybackOptions = function updatePlaybackOptions(_ref6) {
  ...
  if (true && ((typeof timeline === 'undefined' ? 'undefined' : _typeof$2(timeline)) !== 'object' || !timeline.timelineShapes || !timeline.playbackOptions)) {
  ...
  var next = validPlaybackOptions(_extends$2({}, previous, playbackOptions, {
...
var validPlaybackOptions = function validPlaybackOptions(_ref8) {
  ...
  return _extends$2({}, playbackOptions, {
    alternate: alternate,
...
var events = function events(timeline) {
  ...
  timeline.event.previousPlaybackOptions = _extends$1({}, timeline.playbackOptions);
  timeline.event.previousState = _extends$1({}, timeline.state);
};
...
var rotatePoints = function rotatePoints(shape, angle, about) {
  return shape.map(function (point) {
    ...
    var p = _extends$5({}, point, { x: x, y: y });
    ...
    if (p.curve) {
      if (p.curve.type === 'quadratic' || p.curve.type === 'cubic') {
        ...
        p.curve = _extends$5({}, p.curve, { x1: x1, y1: y1 });
      }
      ...
      if (p.curve.type === 'cubic') {
        ...
        p.curve = _extends$5({}, p.curve, { x2: x2, y2: y2 });
      }
    }
  ...
  rules.map(function (_ref) {
    ...
    if (typeof shape[prop] === 'undefined') {
      ...
      if (typeof type !== 'undefined') {
        ...
        } else if (_typeof$7(shape[prop]) !== type) {
    ...
    if (curves) {
      ...
      for (var _i3 = 0, _l3 = cubifiedPoints.length; _i3 < _l3; _i3++) {
        ...
        if (structure[_i3] && !point.curve) {
          nextPoints.push(_extends$3({}, point, {
            curve: {
              type: 'cubic',
              x1: points[_i3 - 1].x,
              y1: points[_i3 - 1].y,
  ...
  if (Array.isArray(structure[0])) {
      ...
      for (var i = 0, l = structure.length; i < l; i++) {
        if (i >= frameShape.childFrameShapes.length) {
          ...
          frameShape.childFrameShapes.push({
            ...
            points: [_extends$3({}, clone(previous[previous.length - 1]), { moveTo: true }), clone(previous[previous.length - 1])]
          });
        }
      }
    }
    ...
    for (var _i5 = 0, _l5 = structure.length; _i5 < _l5; _i5++) {
      ...
      if (!lines[_i5]) {
        ...
        lines[_i5] = [_extends$3({}, clone(previousLine[previousLine.length - 1]), { moveTo: true }), clone(previousLine[previousLine.length - 1])];
      }
...
var frame = function frame(timeline$$1, at) {
  if (true && ((typeof timeline$$1 === 'undefined' ? 'undefined' : _typeof$6(timeline$$1)) !== 'object' || !timeline$$1.timelineShapes || !timeline$$1.playbackOptions)) {
...
var tween = function tween(from, to, easing, position$$1) {
  if (typeof from === 'number') {
    ...
    if (true && to !== null && (typeof to === 'undefined' ? 'undefined' : _typeof$6(to)) !== 'object') {
      throw new TypeError('The tween function\'s from and to arguments must be of an identicle structure');
    }
...
var plainShapeObject$2 = function plainShapeObject(el) {
  if (validNode(el)) {
    ...
    if (type === 'g') {
      ...
      return _extends$10({}, attributes, { type: type, shapes: shapes });
    }

    return _extends$10({}, attributes, plainShapeObjectFromAttrs(type, attributes));
  }
};
...
var validFrameShape = function validFrameShape(frameShp) {
  {
    if ((typeof frameShp === 'undefined' ? 'undefined' : _typeof$11(frameShp)) !== 'object' || Array.isArray(frameShp)) {
    ...
    if ((typeof attributes === 'undefined' ? 'undefined' : _typeof$11(attributes)) !== 'object' || Array.isArray(attributes)) {
    ...
    if (childFrameShapes) {
      ...
      for (var i = 0, l = childFrameShapes.length; i < l; i++) {
        ...
        if ((typeof childFrameShape === 'undefined' ? 'undefined' : _typeof$11(childFrameShape)) !== 'object' || _typeof$11(childFrameShape.attributes) !== 'object') {
...
var validNode = function validNode(el) {
  {
    if ((typeof el === 'undefined' ? 'undefined' : _typeof$11(el)) !== 'object' || !el.nodeName) {
...
var shape$1 = function shape$$1() {
  ...
  for (var i = 0, l = props.length; i < l; i++) {
    ...
    if (prop.el) {
      var p = _extends$12({}, plainShapeObject$2(prop.el), prop);
  ...
  if (replace) {
    if (true && ((typeof replace === 'undefined' ? 'undefined' : _typeof$13(replace)) !== 'object' || !replace.nodeName)) {
...
var treeInWind = document.querySelector('.tree-in-wind');
...
var tree1 = [shape$1(_extends({}, keyframe1, { transforms: [['offset', 0, -24]] }), _extends({}, keyframe2, { transforms: [['offset', 0, -24]] }), { replace: tree }), { name: 'tree1' }];

var tree2 = [shape$1(_extends({}, keyframe1, { transforms: [['offset', 48, 0]] }), _extends({}, keyframe2, { transforms: [['offset', 48, 0]] }), { replace: treeInWind }), { queue: { at: 'tree1' } }];

var tree3 = [shape$1(_extends({}, keyframe1, { transforms: [['offset', -48, 0]] }), _extends({}, keyframe2, { transforms: [['offset', -48, 0]] })), { queue: { at: 'tree1', offset: -500 } }];

var tree4 = [shape$1(_extends({}, keyframe1, { transforms: [['offset', 0, 24]] }), _extends({}, keyframe2, { transforms: [['offset', 0, 24]] })), { queue: { at: 'tree1', offset: -500 } }];
...
var animation = timeline$1(tree1, tree2, tree3, tree4, playbackOptions);
