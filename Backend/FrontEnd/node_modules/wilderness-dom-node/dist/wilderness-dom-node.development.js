(function (global, factory) {
	...
	(factory((global.WildernessDomNode = {})));
...
var nodeData = function nodeData(el) {
  ...
  if (el.hasAttributes()) {
    var attrs = [].concat(toConsumableArray(el.attributes));
  ...
  return { attributes: attributes, childNodes: [].concat(toConsumableArray(el.childNodes)), type: el.nodeName };
};
...
var plainShapeObject = function plainShapeObject(el) {
  if (validNode(el)) {
    ...
    if (type === 'g') {
      ...
      return _extends$1({}, attributes, { type: type, shapes: shapes });
    }

    return _extends$1({}, attributes, plainShapeObjectFromAttrs(type, attributes));
  }
};
...
var updateNode = function updateNode(el, frameShp) {
  ...
  if (!childFrameShapes) {
    ...
    var allChildNodes = [].concat(toConsumableArray(el.childNodes));
    var childNodes = [];
...
var validFrameShape = function validFrameShape(frameShp) {
  {
    if ((typeof frameShp === 'undefined' ? 'undefined' : _typeof$1(frameShp)) !== 'object' || Array.isArray(frameShp)) {
    ...
    if ((typeof attributes === 'undefined' ? 'undefined' : _typeof$1(attributes)) !== 'object' || Array.isArray(attributes)) {
    ...
    if (childFrameShapes) {
      ...
      for (var i = 0, l = childFrameShapes.length; i < l; i++) {
        ...
        if ((typeof childFrameShape === 'undefined' ? 'undefined' : _typeof$1(childFrameShape)) !== 'object' || _typeof$1(childFrameShape.attributes) !== 'object') {
...
var validNode = function validNode(el) {
  {
    if ((typeof el === 'undefined' ? 'undefined' : _typeof$1(el)) !== 'object' || !el.nodeName) {
