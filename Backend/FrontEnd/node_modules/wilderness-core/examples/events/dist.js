...
var updatePlaybackOptions = function updatePlaybackOptions(_ref6) {
  ...
  if (true && ((typeof timeline === 'undefined' ? 'undefined' : _typeof$3(timeline)) !== 'object' || !timeline.timelineShapes || !timeline.playbackOptions)) {
  ...
  var next = validPlaybackOptions(_extends$3({}, previous, playbackOptions, {
...
var validPlaybackOptions = function validPlaybackOptions(_ref8) {
  ...
  return _extends$3({}, playbackOptions, {
    alternate: alternate,
...
var events = function events(timeline) {
  ...
  timeline.event.previousPlaybackOptions = _extends$2({}, timeline.playbackOptions);
  timeline.event.previousState = _extends$2({}, timeline.state);
};
...
var play = function play(timeline) {
  ...
  play$1(timeline, playbackOptions);
  tick(timeline);
};

var tick = function tick(timeline) {
  window.requestAnimationFrame(function () {
    var frameShapes = frame(timeline);

    timeline.timelineShapes.map(function (_ref, i) {
...
var initialIterationsInput = document.querySelector('#initialIterations');
var iterationsInput = document.querySelector('#iterations');
var alternateInput = document.querySelector('#alternate');
var reverseInput = document.querySelector('#reverse');
var durationInput = document.querySelector('#duration');

var playbackOptions = function playbackOptions() {
  var opts = {};

  var initialIterations = initialIterationsInput.value.trim();
  var iterations = iterationsInput.value.trim();
  var alternate = alternateInput.value.trim();
  var reverse = reverseInput.value.trim();
...
var shape1Keyframe1 = { type: 'rect', width: 20, height: 20, x: 0, y: 40, name: 'KEYFRAME_1' };
var shape1Keyframe2 = { type: 'rect', width: 20, height: 20, x: 30, y: 40, name: 'KEYFRAME_2' };

var shape1 = shape(shape1Keyframe1, shape1Keyframe2);

var shape2Keyframe1 = { type: 'rect', width: 20, height: 20, x: 50, y: 40, name: 'KEYFRAME_1' };
var shape2Keyframe2 = { type: 'rect', width: 20, height: 20, x: 80, y: 40, name: 'KEYFRAME_2' };

var shape2 = shape(shape2Keyframe1, shape2Keyframe2);

var animation = timeline([shape1, { name: 'SHAPE_1' }], [shape2, { name: 'SHAPE_2' }]);
...
playButton.addEventListener('click', function () {
  return play(animation, playbackOptions());
});
pauseButton.addEventListener('click', function () {
  return pause(animation, playbackOptions());
});
