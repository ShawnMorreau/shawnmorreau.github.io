...
var plainShapeObject = function plainShapeObject(shape, at) {
  if (true && ((typeof shape === 'undefined' ? 'undefined' : _typeof$9(shape)) !== 'object' || !shape.keyframes)) {
...
var currentCircles = 1;
var allowedCircles = 50;
...
var randomCircle = function randomCircle(from) {
  var r = randomNumber(1, 3.5);
...
var initialR = randomNumber(1, 3.5);

var initialCircle = randomCircle({
  type: 'circle',
...
var renderCircle = function renderCircle(circle) {
  var animation = timeline(circle, {
    alternate: true,
...
var generateNewCircle = function generateNewCircle(circle) {
  var int = setInterval(function () {
    currentCircles++;

    if (currentCircles <= allowedCircles) {
      var nextCircle = randomCircle(plainShapeObject(circle));
