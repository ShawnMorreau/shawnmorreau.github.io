...
var keyframe1 = { type: 'rect', width: 20, height: 20, x: 0, y: 40 };
var keyframe2 = { type: 'rect', width: 20, height: 20, x: 80, y: 40 };

var square = shape(keyframe1, keyframe2);

var animation = timeline(square);
