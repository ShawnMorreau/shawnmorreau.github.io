...
import { currentReverse, iterationsComplete, position as getPosition } from './timeline';
...
var positionTimestamps = function positionTimestamps(_ref4) {
  ...
  var startedPosition = getPosition(initialIterations, reverse);
...
export { activeEventNames, event, eventQueue, oldest, playbackOptionsChanged, positionTimestamps, subscribe, timeToPosition, timeToSamePosition, unsubscribe, validEventName };
